    ...
    return (
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          <ul><li><Link to="/register-as-professional lang">Register As Professional</Link></li><li><Link to="/login" className="lang">Sign In</Link></li><li><Link to="/" className='button-nav lang'>Sign Up</Link></li></ul>
        </div>
      </div>
      </div>
      </div>
