...
class Adminfrhome extends Component {
  constructor(props) {
    super(props);
    this.state = {
      banner_h1: '',
  ...
  onSubmit = e => {
    ...
    axios
      .post('/api/fr/pages/update-detail', data)
      .then(res => {
      ...
      <div className="dashboard-right">
        ...
        <form noValidate onSubmit={this.onSubmit} className="profile form" encType="multipart/form-data">
          ...
          <div className="card-box">
            ...
            <input className="form-control button-nav lang" name="submit" value="Update Details" type="submit"  />
            </div>
